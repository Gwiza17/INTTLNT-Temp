...
const pathways = [
  {
    Icon: Wrench,
    field: 'Engineering',
    degree: 'Master of Engineering Practice',
    dest: 'Canada',
    flag: '🇨🇦',
    href: '/engineering',
    accent: '#3B82F6',
  ...
  },
  {
    Icon: Stethoscope,
    field: 'Nursing',
    degree: 'Master of Nursing Practice',
    dest: 'Australia',
    flag: '🇦🇺',
    href: '/nursing',
    accent: '#10B981',
  },
  {
    Icon: BookOpen,
    field: 'Education',
    degree: 'Bachelor of Teaching (STEM)',
    dest: 'Canada',
    flag: '🇨🇦',
    href: '/teaching',
    accent: '#F59E0B',
...
const steps = [
  {
    ...
    detail:
      'Take our IELTS readiness test and unlock a personalised eligibility report at no cost.',
  },
  {
    n: '02',
    Icon: GraduationCap,
    label: 'Match Your Pathway',
    detail:
      'We match your background, field, and goals to the best degree programme and destination.',
  },
  {
    n: '03',
    Icon: Banknote,
    ...
    detail:
      'Get connected with funders who can cover tuition, living costs, and visa fees.',
  },
  {
    n: '04',
    Icon: Plane,
    label: 'Arrive & Thrive',
    detail:
      'Land with a confirmed place, a support network, and a clear route to residency.',
  },
]
...
const partnerBenefits = [
  {
    ...
    body: 'Manage every candidate referral, track status, and see earnings in one clean dashboard.',
  },
  {
    Icon: Banknote,
    title: 'Competitive Commissions',
    body: 'Earn structured fees per enrolled candidate, paid on a clear milestone schedule.',
  },
  {
    Icon: Globe2,
    title: 'Global Network',
    body: 'Join a growing network of partner agencies across Africa, South Asia, and the Middle East.',
  },
  {
    Icon: BarChart2,
    title: 'Growth Resources',
    body: 'Access marketing materials, co-branded collateral, and priority support from your account manager.',
  },
]

const faqs = [
  {
    q: 'What countries can I study in?',
    a: 'Currently Canada and Australia, with additional destinations being added. Each pathway page lists the specific destination and university partner.',
  },
  {
    q: 'Who is eligible to apply?',
    a: 'Skilled professionals with 2+ years of relevant experience in engineering, technology, healthcare, or education. Take the free diagnostic to confirm your eligibility.',
  },
  {
    q: 'How does education funding work?',
    a: 'After your pathway is confirmed, you are matched with funding partners who can cover tuition, living expenses, and visa fees. Terms are disclosed upfront before you commit.',
  },
  {
    q: 'Do I need to sit an IELTS exam before applying?',
    a: 'No. You start with our free diagnostic tool which tells you where you stand. A formal IELTS test is only required at the point of university application.',
  },
  {
    q: 'How do I sign up as a Channel Partner?',
    a: 'Submit an application via the Partner page. Once approved you get immediate portal access, onboarding materials, and a dedicated account manager.',
  },
  {
    q: 'How long does the full process take?',
    a: 'From diagnostic to arrival typically runs 6–12 months, depending on your pathway and intake dates. Your personalised timeline is generated during the diagnostic.',
  },
]
  ...
  return (
    <div className='overflow-x-hidden font-sans antialiased bg-white text-gray-900'>
      ...
      <section className='relative min-h-screen flex items-end pb-0 overflow-hidden'>
        {/* Background photo (cinematic motion) */}
        <div
          className='absolute inset-0 bg-cover bg-center animate-cinematic'
        ...
        <div className='relative z-10 w-full'>
          <div className='max-w-7xl mx-auto px-6 lg:px-12 pt-40 pb-0'>
            ...
            {/* Headline */}
            <h1
              className='text-white font-black leading-[0.92] tracking-tight mb-8'
              style={{ fontSize: 'clamp(3rem, 9vw, 8rem)' }}
            >
              Your Career.
              <br />
              <span className='text-amber-400'>Fully Funded.</span>
              <br />A World Away.
            </h1>

            <p className='text-gray-300 text-lg lg:text-xl max-w-xl mb-12 leading-relaxed'>
              Inttlnt connects skilled professionals with accredited degree
              programmes, funding, and careers in Canada and Australia — backed
              by a global partner network.
            </p>
            ...
            <div className='flex flex-wrap gap-4 mb-0'>
              ...
              >
                Explore Live Pathways <ArrowRight size={18} />
              </Link>
              <Link
                href='/partner/apply'
        ...
        <div className='max-w-7xl mx-auto'>
          <div className='flex flex-col lg:flex-row lg:items-end justify-between gap-6 mb-16'>
            <div>
              ...
              <h2 className='text-white font-black text-5xl lg:text-6xl leading-tight'>
                4 programmes.
                <br />1 platform.
              </h2>
            </div>
            <p className='text-gray-400 max-w-sm text-base leading-relaxed'>
              Each pathway is a direct route to a recognised qualification,
              residency-ready career, and a new life abroad.
            </p>
          </div>
              ...
              >
                ...
                <div>
                  ...
                  <div
                    ...
                    style={{
                      backgroundColor: pw.accent + '22',
                      border: `1px solid ${pw.accent}44`,
                    }}
                  >
        ...
        <div className='grid lg:grid-cols-2 min-h-[600px]'>
          ...
          <div className='bg-[#0B1F3B] flex flex-col justify-center px-10 lg:px-16 py-20'>
            ...
            <p className='text-gray-300 text-base leading-relaxed mb-10 max-w-md'>
              Thousands of skilled workers in engineering, healthcare, tech, and
              education are eligible for fully-supported study pathways. Your
      ...
      <section className='relative overflow-hidden'>
        <div className='grid lg:grid-cols-2 min-h-[600px]'>
          ...
          <div className='bg-white flex flex-col justify-center px-10 lg:px-16 py-20 order-2 lg:order-1'>
            <p className='text-[#0B1F3B] font-bold uppercase tracking-widest text-xs mb-4'>
            ...
            <p className='text-gray-600 text-base leading-relaxed mb-10 max-w-md'>
              Become an accredited Inttlnt partner and unlock a pipeline of
              pre-qualified candidates, a dedicated portal, and structured
              commissions.
            </p>
      ...
      <section className='py-28 px-6 lg:px-12 bg-gray-50'>
        <div className='max-w-7xl mx-auto'>
          <div className='text-center mb-20'>
            <p className='text-amber-500 font-bold uppercase tracking-widest text-xs mb-3'>
              The Pathway
            </p>
            <h2 className='text-[#0B1F3B] font-black text-5xl lg:text-6xl'>
              From here to there.
            </h2>
          </div>
            ...
            {steps.map((s, i) => (
              <div key={i} className='relative'>
                ...
                <div className='relative z-10'>
                  {/* Step number */}
                  <p className='text-8xl font-black text-amber-100 leading-none mb-2 select-none'>
                    {s.n}
                  </p>
                  ...
                  <h3 className='font-black text-xl text-[#0B1F3B] mb-2'>
                    {s.label}
                  </h3>
        ...
        <div className='relative z-10 max-w-4xl mx-auto text-center'>
          ...
          <h2 className='text-white font-black text-4xl lg:text-6xl leading-tight mb-6'>
            ...
            <span className='text-amber-400'>
              A new country to open them in.
            </span>
          </h2>
          <p className='text-gray-300 text-lg max-w-2xl mx-auto mb-10'>
            Inttlnt graduates don't just get a degree — they get a career
            pathway, a community, and a clear route to permanent residency.
          </p>
          <Link
            href='/livepathways'
      ...
      <section className='py-28 px-6 lg:px-12 bg-white'>
        <div className='max-w-7xl mx-auto grid lg:grid-cols-[1fr_2fr] gap-16'>
          ...
          <div className='lg:sticky lg:top-24 self-start'>
            ...
            <Link
              href='/contact'
              className='inline-flex items-center gap-1 text-amber-600 font-semibold text-sm mt-4 hover:underline'
            >
          ...
          <div className='divide-y divide-gray-100'>
            {faqs.map((f, i) => (
              <div key={i} className='py-5'>
                ...
                >
                  <span
                    className={`font-semibold text-base transition-colors ${openFaq === i ? 'text-amber-600' : 'text-[#0B1F3B] group-hover:text-amber-600'}`}
                  >
                    {f.q}
                  </span>
                  <ChevronDown
      ...
      <section className='grid md:grid-cols-2'>
        ...
        >
          ...
          <div className='relative z-10'>
            ...
            <p className='text-gray-300 text-sm mb-6 max-w-xs'>
              Take the free IELTS diagnostic and see your personalised pathway
              in minutes.
            </p>
            <Link
              href='/ielts'
            ...
            >
              Start Free IELTS Assessment <ArrowRight size={15} />
            </Link>
          </div>
        </div>
        ...
        <div
          className='relative flex flex-col justify-end px-10 lg:px-14 py-20 min-h-[460px] overflow-hidden'
          style={{
            backgroundImage: `url(${P.partner2})`,
            backgroundSize: 'cover',
        ...
        >
          ...
          <div className='relative z-10'>
            ...
            <p className='text-gray-300 text-sm mb-6 max-w-xs'>
              Accredited partners access a live candidate pipeline, a clean
              portal, and competitive commissions.
            </p>
            <Link
              href='/partner/apply'
